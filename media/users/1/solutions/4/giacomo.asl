...
+!execute
   <- println;
      ...
      makeArtifact("hsh_group","ora4mas.nopl.GroupBoard",["src/orgs/house-os.xml", house_group, false, true ],GrArtId);
      ...
      // create the scheme
      makeArtifact("bhsch", "ora4mas.nopl.SchemeBoard",["src/orgs/house-os.xml", build_house_sch, false, true], SchArtId);
      focus(SchArtId);
